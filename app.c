...
else printf("La liste des articles est vides, vous devez la remplir d'abord\n");
}
    ...
    case '1' :
        do{
          ...
          switch(R2){
                    case '1' :
                        ...
                        do {
                            ...
                            switch(G)
                            {
                                case '1' : AjouArti(Pile); printf("\n\n RETOUR [o/n] "); GR=getch();system("cls"); break;
                                case '2' : system("cls"); ModifierArt(Pile); printf("\n\n RETOUR [o/n] "); GR=getch();system("cls"); break;
                                case '3' : system("cls"); SupprimerArticle(Pile); printf("\n\n RETOUR [o/n] "); GR=getch();system("cls"); break;
                                case '4' : GR='n';R3='o';system("cls");break;
                            }
                        }while(GR=='O' || GR=='o');break;
                    case '2' :
                        GR='n';
                        do {
                            system("cls");
                            ...
                            switch(G)
                            {
                                case '1' : do {system("cls");AjouCom(Pile_cmd,Pile,File_per);printf("-Ajouter une nouvelle commande (o/n): ");RC=getch();}while(RC=='o' || RC=='O');printf("\n\n RETOUR [o/n] "); GR=getch();system("cls");break;
                                case '2' : system("cls"); ModifierCommande(Pile_cmd,Pile); printf("\n\n RETOUR [o/n] "); GR=getch();system("cls"); break;
                                case '3' : system("cls"); SupprimerCommande(Pile_cmd); printf("\n\n RETOUR [o/n] "); GR=getch();system("cls"); break;
                                case '4' : GR='n';R3='o';system("cls");break;
                            }
                        }while(GR=='O' || GR=='o');break;
                    case '3' :
                        ...
                        do {
                            ...
                            switch(G)
                            {
                                case '1' : system("cls");AjouPer(File_per); printf("\n\n RETOUR [o/n] "); GR=getch();system("cls"); break;
                                case '2' : system("cls"); ModifierPer(File_per); printf("\n\n RETOUR [o/n] "); GR=getch();system("cls"); break;
                                case '3' : system("cls"); SupprimerPersonne(File_per); printf("\n\n RETOUR [o/n] "); GR=getch();system("cls"); break;
                                case '4' : GR='n';R3='o';system("cls");break;
                            }
                        }while(GR=='O' || GR=='o');break;
                    case '4' : R3='n';system("cls");break;
                    case 'x' : R='n';break;
                    case 'X' : R='n';break;
                    default: R3='o';break;
                    }}while(R3=='o' || R3=='O');break;
          case '2':
            do {
            system("cls");
            P.Y=0;
            ...
            R2=getch();
            switch(R2) {
            case '1' : system("cls");Rech_carac(Pile,'1');printf("\n\n RETOUR [o/n] ");R3=getch(); break;
          ...
          case '3' :
            ...
            R2=getch();
            switch(R2) {
            case '1' : system("cls");affArtiList(Pile);printf("\n\n RETOUR [o/n] ");R3=getch(); break;
            case '2' : system("cls");Affiche_arti_exp(Pile);printf("\n\n RETOUR [o/n] ");R3=getch(); break;
            case '3' : system("cls");AffComList(Pile_cmd);printf("\n\n RETOUR [o/n] ");R3=getch(); break;
            case '4' : system("cls");printf("Entrer le Numero de commande :");scanf("%d",&Ncom);Affichage_cmd(Pile_cmd,Ncom);printf("\n\n RETOUR [o/n] ");R3=getch(); break;
            case '5' : system("cls");AffArtCrit(Pile);printf("\n\n RETOUR [o/n] ");R3=getch(); break;
            case '6' : R='o';R3='n';system("cls"); break;
            case 'x' : R='n';R3='n'; break;
            case 'X' : R='n';R3='n'; break;
            default : R3='o'; break;
          ...
          printf("Selectionner quoi vous voulez afficher");
            ...
            R3='n';
          switch(R2){
                    case '1' : system("cls"); ArtPlusVendu(Pile);printf("\n\n RETOUR [o/n] "); R3=getch();system("cls"); break;
                    case '2' : system("cls"); NBComClient(File_per); printf("\n\n RETOUR [o/n] "); R3=getch();system("cls");break;
                    case '3' : system("cls"); PireClient(File_per); printf("\n\n RETOUR [o/n] "); R3=getch();system("cls");break;
                    case '4' : R3='n';system("cls");break;
                    case 'x' : R='n';break;
                    case 'X' : R='n';break;
                    default: R3='o';break;
