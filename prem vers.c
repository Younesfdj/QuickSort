    ...
    case '1' :
        do{
          ...
          printf("Veuillez choisir le type de votre traitement");
            ...
            R3='n';
          switch(R2){
                    case '1' : AjouArti(Pile); printf("\n\n RETOUR [o/n] "); R=getch();system("cls"); break;
                    ...
                    case '3' : R='o';system("cls");break;
                    case 'x' : R='n';P.Y=22;P.X=61;SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), P);break;
                    case 'X' : R='n';P.Y=22;P.X=61;SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), P);break;
                    default: R3='o';break;
